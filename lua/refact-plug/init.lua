...
function M.hello()
	...
	for _, key in ipairs(closingKeys) do
		-- CORREÇÃO: Usar vim.keymap.set para ligar a tecla diretamente à função Lua M.bye
		-- O parâmetro 'buffer = buf' torna o mapa local apenas para essa janela flutuante
